...
namespace eval Model_Check {
	...
	proc Window {} {	    
		...
		hwtk::entry $w.msg.ent2 -width 35 -state readonly -textvariable Model_Check::Comp_Name
		hwtk::label $w.msg.lab3 -text "Figure NO:"
		hwtk::entry $w.msg.ent3 -width 12 -state normal -textvariable Model_Check::Comp_FN
		hwtk::label $w.msg.lab4 -text "Version NO.:"
		hwtk::entry $w.msg.ent4 -width 8 -state normal -textvariable Model_Check::ver_num
		pack $w.msg -side top -fill x
		pack $w.msg.lab1 $w.msg.ent1 $w.msg.lab2 $w.msg.ent2 $w.msg.lab3 $w.msg.ent3 $w.msg.lab4 $w.msg.ent4 -side left -expand 1
		...
		hwtk::checkbutton $w.dis.cb3_1 -text "Con Comps" -variable Model_Check::Conect_w_Flag -command "Model_Check::View_Comp 0 0"
		...
		pack $w.dis.cb1 $w.dis.cb2 $w.dis.cb3 $w.dis.cb3_1 $w.dis.cb4 -side left -expand 1
		...
		hwtk::button $w.but.c -text "Close" -command "catch {*deleteedges }; destroy $w"
	...
	proc Modify_Comp {} {
		...
		if { $Model_Check::Comp_Prop == "PSHELL"} {
		    ...
		    set PropName "$figID\_2d_$Thickness\_$matname\_$Model_Check::ver_num" 
		    ...
		    set tmp [split $basename "."]
		    set figID [string trim [lindex $tmp 0] " "]
		    set PropName "$figID\_3d_$matname\_$Model_Check::ver_num"
	...
	proc View_Comp {flag flag2} {
		...
		*isolateonlyentity comps "by id" $Model_Check::Comp_ID 
		...
		if {$Model_Check::Conect_w_Flag == 1} {
		    set ConIDs [Find_Connector $Model_Check::Comp_ID]
			set concomps {}
			foreach conid $ConIDs {
			    set concomps [concat $concomps [hm_ce_getlinkentities $conid components]]
			}
			eval *createmark comps 2 "by id" $concomps
	...
	proc Find_Connector {CompID} {
		...
		*clearmark connectors 1
		...
		foreach con_id $con_ids {
			...
			if {$flag != -1} {
			    *showentity connectors "by id" $con_id 
	...
	proc Start {} {
		...
		set Model_Check::Conect_w_Flag 0
